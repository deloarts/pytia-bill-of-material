...
class Frames:
    ...
    def __init__(self, root: Tk) -> None:
        ...
        self._frame_paths.grid(
            row=1, column=0, sticky="nsew", padx=(10, 5), pady=(5, 5)
        )
        ...
        self._frame_export.grid(
            row=2, column=0, sticky="nsew", padx=(10, 5), pady=(5, 10)
        )
        ...
        self._frame_filters_wrapper.grid(
            row=0, column=1, sticky="nsew", padx=(5, 10), pady=(10, 10), rowspan=3
        )
        self._frame_filters_wrapper.grid_rowconfigure(0, weight=1)
        self._frame_filters_wrapper.grid_columnconfigure(0, weight=1)

        self._frame_filters_elements = ScrolledFrame(
            master=self._frame_filters_wrapper, autohide=True, padding=10
        )
        ...
        self._frame_report_footer.grid(
            row=4, column=0, sticky="swe", padx=10, pady=(5, 10), columnspan=2
        )
