...
def get_bom_export_name(workspace: Workspace, project: str, product: str) -> str:
    """
    ...
    `PROJECT_NUMBER PRODUCT_NUMBER BOM_NAME`
    ...
    Args:
        ...
        product (str): The product number for the final file.
...
def get_data_export_name(bom_item: BOMAssemblyItem, with_project: bool) -> str:
    ...
    `PRODUCT_NUMBER PARTNUMBER REVISION` or `PROJECT_NUMBER PRODUCT_NUMBER PARTNUMBER REVISION`
    ...
    """
    value = (
        f"{bom_item.properties[resource.bom.required_header_items.product]} "
